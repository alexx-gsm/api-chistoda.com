 ...
 * Generated for Laravel 5.4.16 on 2017-03-26.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Request {
         ...
         *
         * @param string $format The format
         * @param string|array $mimeTypes The associated mime types (the preferred one must be the first as it will be used as the pages type)
         * @static 
         */
         ...
         *
         * @return string|null The format (null if no pages type is present)
         * @static 
         */
        ...
        /**
         * Returns the request body pages.
         *
         * @param bool $asResource If true, a resource will be returned
         * @return string|resource The request body pages or a resource to read the body stream
         * @throws \LogicException
         * @static 
         */
        ...
        /**
         * Gets a list of pages types acceptable by the client browser.
         *
         * @return array List of pages types in preferable order
         * @static 
         */
        ...
        /**
         * Determine if the given pages types match.
         *
         * @param string $actual
         * @param string $type
         * @return bool 
        ...
        /**
         * Determines whether the current requests accepts a given pages type.
         *
        ...
        /**
         * Return the most suitable pages type from the given array based on pages negotiation.
         *
         * @param string|array $contentTypes
         * @return string|null 
         * @static 
    ...
    class View {
        ...
        /**
         * Get the rendered pages of the view based on a given condition.
         *
        ...
        /**
         * Save the slot pages for rendering.
         *
         * @return void 
         * @static 
         */
        ...
        /**
         * Start injecting pages into a section.
         *
        ...
        /**
         * Inject inline pages into a section.
         *
         * @param string $section
         * @param string $content
         * @return void 
        ...
        /**
         * Stop injecting pages into a section and return its contents.
         *
         * @return string 
         * @static 
         */
        ...
        /**
         * Stop injecting pages into a section.
         *
         * @param bool $overwrite
         * @return string 
         * @throws \InvalidArgumentException
        ...
        /**
         * Stop injecting pages into a section and append it.
         *
         * @return string 
         * @throws \InvalidArgumentException
         * @static 
        ...
        /**
         * Start injecting pages into a push section.
         *
         * @param string $section
         * @param string $content
         * @return void 
        ...
        /**
         * Stop injecting pages into a push section.
         *
         * @return string 
         * @throws \InvalidArgumentException
         * @static 
        ...
        /**
         * Start prepending pages into a push section.
         *
         * @param string $section
         * @param string $content
         * @return void 
        ...
        /**
         * Stop prepending pages into a push section.
         *
         * @return string 
         * @throws \InvalidArgumentException
         * @static 
